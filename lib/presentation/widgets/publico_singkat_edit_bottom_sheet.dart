...
class PublicoSingkatEditBottomSheet extends StatelessWidget {
  final BuildContext parentContext;
  final int bookmarkCount;
  final Function()? onEditPressed;
  final Function()? onDeletePressed;

  const PublicoSingkatEditBottomSheet({
    Key? key,
                      ...
                      child: Column(
                        children: [
                          ...
                          BlocConsumer<VideoSingkatCubit, VideoSingkatState>(
                            listener: (_, state) {
                              if (state is DeleteVideoSingkatSuccess) {
                            ...
                            builder: (builderContext, state) {
                              if (state is DeleteVideoSingkatLoading) {
